...
Please note that the name of the sol file has to be the same as the name of the contract. If there are more than one contract in a file, the contract with the same name of the file's would be deployed.
